...
- `OPENAI_API_CHAT_COMPLETION_MODEL` - This is a required variable that specifies the OpenAI model used for text completion. You can find a list of available models [here](https://platform.openai.com/docs/models/gpt-4). We recommend using the `text-davinci-003` model.
